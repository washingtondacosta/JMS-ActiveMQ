...
public class Chat implements MessageListener {
    ...
    public Chat(String topicFactory, String topicName, String username) throws Exception {
        // Obtem os dados da conexao JNDI atraves do arquivo jndi.properties
        ...
        // Utiliza o TopicConnectionFactory para criar a conexao com o provedor JMS
        TopicConnection connection = conFactory.createTopicConnection();
        
        // Utiliza o TopicConnection para criar a sessao para o produtor
        // Atributo false -> uso ou nao de transacoes (tratar uma serie de envios/recebimentos como unidade atomica e controla-la via commit e rollback)
        ...
        // Cria o topico JMS do produtor das mensagens atraves da sessao e o nome do topico
        TopicPublisher publisher = pubSession.createPublisher(chatTopic);
			
        // Cria (Assina) o topico JMS do consumidor das mensagens atraves da sessao e o nome do topico
        TopicSubscriber subscriber = subSession.createSubscriber(chatTopic);
        
        // Escuta o topico para receber as mensagens atraves do metodo onMessage()
        ...
        // Inicia a conexao JMS, permite que mensagens sejam entregues
        connection.start();
    }
    ...
    public void onMessage(Message message) {
        try {
            // As mensagens criadas como TextMessage e devem ser recebidas como TextMessage
    ...
    public static void main(String[] args) {
        try {
            ...
            // Depois da conexao criada, faz um loop para enviar mensagens
            while (true) {
                ...
                if (s.equalsIgnoreCase("exit")) {
                    ...
                    //envia a mensagem digitada no console para o metodo writeMessage que vai publica-la
                    chat.writeMessage(s);
                }
            }
        } catch (Exception e) {
